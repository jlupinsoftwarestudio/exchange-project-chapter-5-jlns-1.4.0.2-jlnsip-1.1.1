...
SET JLUPIN_CLASSPATH=%CLASSPATH_START%\jlupin-starter-1.4.0.2.jar;%CLASSPATH_START%\jlupin-util-1.4.0.2.jar;%CLASSPATH_START%\jlupin-starter-logger-1.4.0.2.jar;%CLASSPATH_START%\jlupin-reference-container-1.4.0.2.jar;%CLASSPATH_START%\jlupin-interfaces-1.4.0.2.jar;%CLASSPATH_START%\jlupin-classloader-1.4.0.2.jar;%CLASSPATH_START%\jlupin-command-interpreter-1.4.0.2.jar;%CLASSPATH_START%\jlupin-command-executor-1.4.0.2.jar;%CLASSPATH_START%\jlupin-classloader-manager-1.4.0.2.jar;%CLASSPATH_START%\jlupin-compilator-1.4.0.2.jar;%CLASSPATH_START%\jlupin-singleton-container-1.4.0.2.jar;%CLASSPATH_START%\jlupin-starter-logger-manager-1.4.0.2.jar;%CLASSPATH_START%\jlupin-control-information-1.4.0.2.jar;%CLASSPATH_START%\jlupin-common-1.4.0.2.jar;%CLASSPATH_START%\jlupin-printstream-strategy-manager-1.4.0.2.jar;%CLASSPATH_START%\jlupin-client-1.4.0.2.jar;%CLASSPATH_START%\ext\snakeyaml-1.11.jar

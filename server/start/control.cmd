...
%JLUPIN_JAVA_EXE% -Dconsole.upload.dir=%SCRIPT_PATH%..\upload -Dcontrol.address="127.0.0.1" -Dcontrol.port="9096" -Dcontrol.connectionTimeout="1000" -Dcontrol.readTimeout="300000" -jar %SCRIPT_PATH%control\control.jar %ARGS%
